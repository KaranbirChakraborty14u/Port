...
import img1 from "../Photos/Janashankhiya/Janashankiya1.jpeg";

const Janashankiya = () => {
  const [emblaRef, emblaApi] = useEmblaCarousel({ loop: true });
  const [selectedIndex, setSelectedIndex] = useState(0);

  const images = [img1]; // Add more images as needed
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto relative">
      <h1 className="text-2xl font-bold mb-4">Janashankiya</h1>
