  ...
  return (
    <>
      <motion.div
        ...
        className="md:mb-12 mb-12 p-4 max-w-5xl md:max-w-5xl mx-auto relative font-[Outfit,sans-serif]"
      >
        <h1 className="text-center text-2xl md:text-3xl sm:text-4xl font-bold text-black -mt-20 mb-16 md:-mt-8 md:mb-16">
          Bodoland International
        ...
        >
            ...
            {images.map((src, index) => (
              ...
              >
                <img
                  src={src}
                  alt={`slide-${index}`}
                  className="w-full h-[390px] md:h-[560px] sm:h-[400px] object-cover rounded-xl transform group-hover:scale-105 transition-transform duration-300 ease-in-out"
                />
              </div>
            ))}
          </div>
          ...
          <button
            onClick={scrollPrev}
            className="absolute top-1/2 left-1 md:left-3 transform -translate-y-1/2 bg-white hover:bg-gray-200 transition p-2 rounded-full shadow-lg z-10"
          >
