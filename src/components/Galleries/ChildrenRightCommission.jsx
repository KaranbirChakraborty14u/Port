...
import img1 from "../Photos/Child Right Commission/Child_rights.jpeg";
import img2 from "../Photos/Child Right Commission/Child_rights2.jpeg";
import img3 from "../Photos/Child Right Commission/Child_rights3.jpeg";
import img4 from "../Photos/Child Right Commission/Child_rights4.jpeg";

const ChildrenRightCommission = () => {
  ...
  return (
    <>
      <motion.div
        ...
        className="md:mb-12 mb-12 p-4 max-w-7xl mx-auto relative font-[Outfit,sans-serif]"
      >
          ...
          <div className="flex">
            {images.map((src, index) => (
              ...
              >
                <img
                  src={src}
                  alt={`Child Rights image ${index + 1}`}
                  className="w-full h-[360px] md:h-[760px] sm:h-[400px] object-cover rounded-xl transform group-hover:scale-105 transition-transform duration-300 ease-in-out"
                />
              </div>
            ))}
          </div>
          ...
          <div className="flex gap-3">
            {images.map((src, index) => (
              ...
              >
                <img
                  src={src}
                  alt={`Thumbnail for child rights image ${index + 1}`}
...
export default ChildrenRightCommission;
